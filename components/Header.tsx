...
export function Header() {
  ...
  const { connect, disconnect, account, connected } = useEVMWallet();
  ...
  // EVM wallets are accessed via window.ethereum (MetaMask, etc.)
  const installedWallets: any[] = [];
          ...
          >
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  <Link href="/" className="text-white hover:text-pink-400 transition-colors duration-300">AutoDeFi</Link>
                </motion.span>
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="bg-white/10 backdrop-blur-xl border border-white/20">
                  ...
                  <div className="grid gap-2">
                    <Button variant="outline" className="justify-start bg-white/5 border-white/20 text-white hover:bg-white/10" onClick={handleConnect}>
                      <Wallet className="w-4 h-4 mr-2" />
